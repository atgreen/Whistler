...
(test eth-type-access
  ...
  (let ((bytes (w-body "(let ((data (ctx-load u32 0))
                              (data-end (ctx-load u32 4)))
                          (declare (type u64 data) (type u64 data-end))
...
(test parse-eth-compiles
  ...
  (let ((n (w-count "(let ((data (ctx-load u32 0))
                           (data-end (ctx-load u32 4)))
                       (declare (type u64 data) (type u64 data-end))
                       (let ((eth (parse-eth data data-end)))
                         (declare (type u64 eth))
...
(test parse-tcp-compiles
  ...
  (let ((n (w-count "(let ((data (ctx-load u32 0))
                           (data-end (ctx-load u32 4)))
                       (declare (type u64 data) (type u64 data-end))
                       (let ((tcp (parse-tcp data data-end)))
                         (declare (type u64 tcp))
