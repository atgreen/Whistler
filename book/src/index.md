...
`examples/*.c`): a packet counter ties at 12; a port blocker (**25 vs 27**), a
SYN-flood mitigator (**70 vs 73**), and a tail-call dispatcher (**27 vs 29**)
each come in tighter than clang. The comparison is reproducible: `make bench`.
